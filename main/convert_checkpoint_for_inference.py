...
def main(
    ...
    del ckpt['callbacks']
    ckpt['hyper_parameters']['tokenizer']['segmentation_only'] = True
    ckpt['hyper_parameters']['tokenizer']['emb_file'] = 'unused'
    ckpt['hyper_parameters']['tokenizer']['model_file'] = './tokenizers/ru.wiki.bpe.vs200000.model'
    ckpt['hyper_parameters']['tokenizer']['lang'] = None
    ckpt['hyper_parameters']['model']['text']['encoder']['pretrained_bpemb_embeddings'] = False
    ckpt['hyper_parameters']['model']['image']['encoder']['weights'] = None
